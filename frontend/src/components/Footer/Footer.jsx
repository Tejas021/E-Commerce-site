...
<div className="about">
  ...
  <div className="social-media mx-auto">
    <ul className="list-inline list-group list-group-horizontal ">
      <li className='mx-1'><a href="http://www.nextbootstrap.com/" title=""><i className="fa fa-facebook "></i></a></li>
      <li className='mx-1'><a href="http://www.nextbootstrap.com/" title=""><i className="fa fa-twitter"></i></a></li>
      <li className='mx-1'><a href="http://www.nextbootstrap.com/" title=""><i className="fa fa-google-plus"></i></a></li>
      <li className='mx-1'><a href="http://www.nextbootstrap.com/" title=""><i className="fa fa-linkedin"></i></a></li>
    </ul>
  </div>
</div>
